...
const Navbar = () => {
  ...
  const hireMeMailto = `mailto:devadraprasadkumar@gmail.com?subject=Hiring Inquiry – Portfolio&body=Hello DEVENDRA PRASAD K,%0D%0A%0D%0AI came across your portfolio and would like to discuss an opportunity with you.%0D%0A%0D%0ALooking forward to hearing from you.%0D%0ABest Regards,`;
